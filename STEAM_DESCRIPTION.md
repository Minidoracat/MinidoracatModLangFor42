...
[*] 有效覆蓋率 100.0%（截至 2026-09-03）——現行有效上游翻譯鍵 112,222 個中已覆蓋 112,216 個；餘 6 鍵只存在於已下架、無法重新下載的 FR Operator。上游每天更新，新增文本由追蹤器偵測後持續補譯，故此數字會隨上游浮動。另有少數模組把文字寫死在程式碼裡，任何翻譯包都補不了（已於支援清單逐一標註）
