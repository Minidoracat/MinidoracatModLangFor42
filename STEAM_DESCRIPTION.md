...
[*] 有效覆蓋率約 94%——現行有效上游翻譯鍵 111,998 個中已覆蓋 104,809 個；其餘 7,189 鍵多為其他原始 MOD 新增／更新、尚未被 As1 收錄的文本，會持續排入補譯。另有少數模組把文字寫死在程式碼裡，任何翻譯包都補不了（已於支援清單逐一標註）
